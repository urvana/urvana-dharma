    ...
    <div className="">
            ...
            <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                  ...
                  <a href={"https://urvana.net/formulario/dharma"} className="font-medium text-blue-600 hover:text-blue-500 inline-flex items-center space-x-1">
                    <span>
                      Ingresar predios
                    </span>
            ...
            >
              ...
              >
                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <a href={"https://urvana.net/formulario/dharma"} className="w-full px-5 py-3 text-center font-medium text-blue-600 bg-gray-50 hover:bg-gray-100 flex items-center space-x-1">
                    <span>
                      Ingresar predios
                    </span>
                    <ExternalLinkIcon className="inline w-4 h-4" />
            ...
            <div className="sm:text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <a
                    href="https://urvana.net?ref=demo"
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href={"https://urvana.net/formulario/dharma"}
                    {...EXTERNAL({ follow: true })}
      ...
      <footer className="py-8 px-4 space-y-8 w-full max-w-screen-md mx-auto flex flex-col items-center">
        ...
        <p className="text-gray-500 text-base text-center">
          ...
          estamos modernizando la provisión de terrenos para desarrollo inmobiliario.
        </p>
...
export function EXTERNAL({ referrer = true, opener = false, follow = false } = {}) {
  const rel = [];
  if (referrer === false) rel.push("noreferrer");
  if (opener === false) rel.push("noopener");
  if (follow === false) rel.push("nofollow");
...
export const FOOTER_SOCIAL = [
  ...
  {
    name: "Email",
    href: "mailto:hola@urvana.net",
    icon: (props) => <MailIcon fill="currentColor" {...props} />,
  },
];
